...
stdenvNoCC.mkDerivation (finalAttrs: {
  ...
  src = fetchurl {
    ...
    hash = "sha256-C/QH62f+PjwksPTI3qjLY+B/Y8oPds8gWFZRQ1B6uF4=";
  };
  nativeBuildInputs = [
    autoconf
    automake
  ...
  preBuild = ''
    tar czf bootstrap-sources.tar.gz -C ${
      stdenvNoCC.mkDerivation {
        ...
        src = finalAttrs.src;
        prePatch =
          assert ghc.version == "9.4.8";
          ''
            cp ${./plan-bootstrap-9_4_8.json} hadrian/bootstrap/plan-bootstrap-9_4_8.json
          '';
        nativeBuildInputs = [
          python3
          ghc
        ...
        installPhase = ''
          ...
          runHook postInstall
        '';
        outputHash = "sha256-v8OGTQ8KCGEwm8IA4GxnfKeNRQW2RCdLnNveoII4rik=";
